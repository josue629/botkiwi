  ...
  try {
    ...
    mess = {
      ...
      error: {
        ...
        Iv: "Enlace de error :v",
      },
      only: {
        group: "Especial para grupo ngab",
      },
    };
    ...
    if (isGroup && isAntilink && !mek.key.fromMe) {
      if (budy.includes("://chat.whatsapp.com/")) {
        ...
        reply("ANTILINK DETECTED!! LO SENTIMOS SERÁ PATADA  ;V");
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 700) {
        if (isGroupAdmins) return reply("admin bebas");
        reply("ANTIVIRTEX DETECTED!! LO SENTIMOS SERÁ PATADA ;V");
        client.groupRemove(from, sender);
      }
    }
...
`;
        sendButImage(from, menu, "No olvides seguir a ig @ arcadia330 ..", thumb, [
          {
      ...
      case "antilink":
        ...
        if (args[0] == "on") {
          ...
          reply("Activar el antienlace con éxito!");
        } else if (args[0] == "off") {
          ...
          reply("¡Éxito al desactivar el antienlace!");
        } else if (!q) {
          sendButMessage(from, `MODE ANTILINK`, `Por favor elige uno`, [
            {
